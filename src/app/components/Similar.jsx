    ...
    <div className="w-full px-4 sm:px-6 lg:px-8 py-10 bg-[#FBF9F899]">
      <div className="max-w-7xl mx-auto">
        <div className="w-full flex flex-col sm:flex-row justify-between items-center mb-6">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-medium mb-4 sm:mb-0">
            Articles similaires
          </h1>
          <span className="underline text-[#393939] uppercase font-medium text-sm sm:text-base cursor-pointer hover:opacity-75">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-5">
          {[...Array(5)].map((_, index) => (
            <div key={index} className="w-full">
              <div className="w-full bg-[#F9F7F5] p-4 sm:p-6 lg:p-10 relative rounded-md">
                <Image
                  src={table}
                  alt="table"
              ...
              <div className="p-2">
                ...
                <div className="w-full flex items-center justify-between flex-wrap sm:flex-nowrap mt-1">
                  ...
                  <span className="flex truncate bg-[#F1F4F6] px-2 py-1 mt-2 sm:mt-0 text-[#546A7D] text-xs rounded-full font-medium">
                    20 pièces
                  </span>
                </div>
              </div>
